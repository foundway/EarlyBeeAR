...
{
	typedef void (*Action)(void*, T1, T2, T3, T4, T5, T6, T7, MethodInfo*);

	static inline void Invoke (MethodInfo* method, void* obj, T1 p1, T2 p2, T3 p3, T4 p4, T5 p5, T6 p6, T7 p7)
	{
		VirtualInvokeData data = il2cpp::vm::Runtime::GetInterfaceInvokeData (method, obj);
...
{
	typedef R (*Func)(void*, T1, T2, T3, T4, T5, T6, T7, T8, T9, MethodInfo*);

	static inline R Invoke (MethodInfo* method, void* obj, T1 p1, T2 p2, T3 p3, T4 p4, T5 p5, T6 p6, T7 p7, T8 p8, T9 p9)
	{
		VirtualInvokeData data = il2cpp::vm::Runtime::GetInterfaceInvokeData (method, obj);
