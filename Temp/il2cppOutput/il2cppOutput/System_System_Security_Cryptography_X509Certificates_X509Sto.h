...
struct  X509Store_t1682  : public Object_t
{
	...
	X509Certificate2Collection_t1672 * ___list_2;
	...
	X509Store_t1697 * ___store_4;
};
struct X509Store_t1682_StaticFields{
	...
	Dictionary_2_t1042 * ___U3CU3Ef__switch$mapF_5;
};
