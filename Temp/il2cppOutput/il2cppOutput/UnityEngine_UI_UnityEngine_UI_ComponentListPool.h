...
struct  ComponentListPool_t487  : public Object_t
{
};
struct ComponentListPool_t487_StaticFields{
	...
	ObjectPool_1_t485 * ___s_ComponentListPool_0;
	...
	UnityAction_1_t486 * ___U3CU3Ef__am$cache1_1;
};
