...
struct  X509EnhancedKeyUsageExtension_t1689  : public X509Extension_t1668
{
	...
	OidCollection_t1687 * ____enhKeyUsage_4;
...
struct X509EnhancedKeyUsageExtension_t1689_StaticFields{
	...
	Dictionary_2_t1042 * ___U3CU3Ef__switch$mapE_6;
};
